...
namespace HonzCore.Helpers
{
    class ContentHelper : IHelper
    {
        ...
        {                                                                                       //i woas oba i hob keine ahnung wie i des sunst doa soi
            DirectoryInfo dir = new DirectoryInfo(Path.GetDirectoryName(Path.GetDirectoryName(Path.GetDirectoryName(Path.GetDirectoryName(Directory.GetCurrentDirectory())))) + "/" + contentManager.RootDirectory + "/" + contentFolder);
            if (!dir.Exists)
